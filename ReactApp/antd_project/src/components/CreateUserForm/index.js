...
export default class CreateUserForm extends Component {
   ...
   */
    ...
    treeSelectOnChange = (val) => {
        console.log("treeSelectOnChange", val);
        if (!this.state.isEdit) {
            let tempFormData = this.state.formData;
            tempFormData.ncId = val;
            // this.state.moduleList.map((item) => {
            //     if (item.id == val) {
            //         tempFormData.ncId = item.id;
            //     }
            // })
            this.setState({
                treeSelectvalue: val,
                ...
                <Spin spinning={this.state.loading}>
                    <Form {...formItemLayout}>
                        ...
                        {/* <Form.Item label="用户密码" {...validateList[2]} required={true}>
                            <div>
                                <Input.Password placeholder="请输入密码" defaultValue="123456" onChange={(e) => {
                                    let tempFormData = this.state.formData;
                        ...
                        <Form.Item label="确认密码" {...validateList[3]} required={true}>
                            <div>
                                <Input.Password placeholder="请确认密码"  defaultValue="123456"
                        ...
                        <Form.Item
                            ...
                            <div>
                                <Select
                                    ...
                                    style={{ width: '100%' }}
                                    placeholder="选择角色"
                                    defaultValue={this.state.formData.roleIds}
